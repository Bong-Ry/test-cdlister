document.addEventListener('DOMContentLoaded', () => {
    ...
    function createRow(record) {
        const j1Image   = record.images?.find(img => img.name.toUpperCase().startsWith('J1_'));
        ...
        const priceOptions = ['19.99', '14.99', '24.99', '29.99', '39.99']; // CD用の価格帯
                    ...
                    <div class="input-section">
                        ...
                        <div class="input-group">
                            ...
                            <select name="shipping" ${isError ? 'disabled' : ''}>
                                <option value="#10USD-DHL FedEx">10USD</option>
                                <option value="#15USD-DHL FedEx">15USD</option>
                                <option value="#20USD-DHL FedEx">20USD</option>
                            </select>
                        </div>
                    </div>
